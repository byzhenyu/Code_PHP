...
class AjaxPage {
    ...
    public function show() {
        ...
        if ($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1) {
            $the_first = '<li id="example1_previous" class="paginate_button previous"><a class="first" data-p="1" href="javascript:void(0)">' . $this->config['first'] . '</a></li>';
        }

        //最后一页
        $the_end = '';
        if ($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages) {
            $the_end = '<li id="example1_previous" class="paginate_button previous"><a class="end" data-p="' . $this->totalPages . '" href="javascript:void(0)">' . $this->config['last'] . '</a></li>';
        }
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<ul class='pagination page' style='float: right'>{$page_str}</ul>";
    }
}
