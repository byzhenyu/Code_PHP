...
class ArticleCategoryModel extends Model{
    ...
    protected $_validate = array(
        array('name','require','文章分类名称不能为空', self::EXISTS_VALIDATE),
        array('name', '1,20', '文章分类名称不能超过20', self::EXISTS_VALIDATE, 'length', 3),
        array('name', 'checkName', '文章分类名称已经存在, 不能重复添加', self::EXISTS_VALIDATE, 'callback', 3),
        ...
        // array('simple_name', 'checkName', '文章分类简介已经存在, 不能重复添加', self::EXISTS_VALIDATE, 'callback', 3),
