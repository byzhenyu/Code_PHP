...
class AuthGroupModel extends Model {
    ...
    protected $_validate = array(
        ...
        array('title','0,20', '用户标题最多20字符', Model::VALUE_VALIDATE , 'length'  ,Model::MODEL_BOTH ),

        array('description','0,1000', '描述最多1000字符', Model::VALUE_VALIDATE , 'length'  ,Model::MODEL_BOTH ),
    );


    /**
     * 获取所有有效的分组
     * @author liuyang 594353842
     */
