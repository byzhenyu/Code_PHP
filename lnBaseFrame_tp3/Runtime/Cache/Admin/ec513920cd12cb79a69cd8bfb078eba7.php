...
<body>
	...
	<div class="tw-list-hd">
             <?php echo isset($info['id'])?'编辑':'新增';?>文章分类
        </div>
		
	    <div class="tw-list-wrap tw-edit-wrap">
            <form action="/index.php/Admin/ArticleCategory/edit" method="post" class="form-horizontal ajaxForm" enctype="multipart/form-data">
                <div class="form-item">
                    <label class="item-label">文章分类名称<span class="check-tips"><b>*</b>（输入文章分类名称）</span></label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="name" value="<?php echo ($info["name"]); ?>">
                    </div>
                </div>
                <!-- <div class="form-item">
                    <label class="item-label">文章分类简称<span class="check-tips"><b>*</b>（输入文章分类简称）</span></label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="simple_name" value="<?php echo ($info["simple_name"]); ?>">
                    </div>
                </div> -->
                <div class="form-item">
                    <label class="item-label">上级分类<span class="check-tips"><b>*</b>（上级分类）</span></label>
                    <div class="controls">
