...
<body id="mainbody">
    ...
    <div class="header">
        <!-- Logo -->
        <span class="logo"><img src='/Public/images/logo0.png'>
        </span>
        <!-- /Logo -->
        ...
        <div class="user-bar">
            ...
            <ul class="nav-list user-menu hidden">
                <li class="manager">你好，<em title="<?php echo session('user_auth.username');?>"><?php echo session('admin_auth.real_name');?></em></li>
