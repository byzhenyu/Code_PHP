        ...
        <div class="login-body">
            <div class="login-main pr">
                <form action="<?php echo U('doLogin');?>" method="post" class="login-form">
                    <h3 class="welcome" style="margin-left: -40px"><img src="/Public/images/logo.png" style="width:262px;display: block;margin:0 auto"><!--<?php echo C('WEB_SITE_TITLE');?>--></h3>
                    <div id="itemBox" class="item-box">
                        ...
                        <div>
                            <img style="height: 40px;width: 100px;" class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('Public/verify');?>">
                        </div> 
                    </div>
